...
/***/ function(module, exports, __webpack_require__) {
	...
	var _containersAppJs = __webpack_require__(177);

	var _containersAppJs2 = _interopRequireDefault(_containersAppJs);

	var _reducersReducersJs = __webpack_require__(183);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionsActionsJs = __webpack_require__(178);
	...
	function selectTodos(todos, filter) {
	  switch (filter) {
	    case _actionsActionsJs.VisibilityFilters.SHOW_ALL:
	      return todos;
	    case _actionsActionsJs.VisibilityFilters.SHOW_COMPLETED:
	      return todos.filter(function (todo) {
	        return todo.completed;
	      });
	    case _actionsActionsJs.VisibilityFilters.SHOW_ACTIVE:
	      return todos.filter(function (todo) {
	        return !todo.completed;
	      });
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionsActionsJs = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./actions/actions.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

	var SHOW_ALL = _actionsActionsJs.VisibilityFilters.SHOW_ALL;

	function visibilityFilter(state, action) {
	  if (state === undefined) state = SHOW_ALL;

	  switch (action.type) {
	    case _actionsActionsJs.SET_VISIBILITY_FILTER:
	...
	function todos(state, action) {
	  ...
	  switch (action.type) {
	    case _actionsActionsJs.ADD_TODO:
	      return [].concat(_toConsumableArray(state), [{
	        text: action.text,
	        completed: false
	      }]);
	    case _actionsActionsJs.COMPLETE_TODO:
